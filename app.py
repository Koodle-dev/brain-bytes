...
tavily_client = TavilyClient(api_key="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")
...
def summarize_with_ollama(text, level):
    ...
    prompt += f"\n\nPut the summary in a markdown format with headings, subheadings, and bullet points. Here's the text to summarize:\n\n{text}\n\n"
        ...
        if query:
            ...
            if search_results and 'results' in search_results:
                ...
                with st.spinner("summarizing the information..."):
                    summarized_text = summarize_with_ollama(combined_results, level)
